class AddCachedVotesToContents < ActiveRecord::Migration
  def self.up
    ...
    add_column :contents, :cached_weighted_score, :integer, :default => 0
    ...
    add_index  :contents, :cached_weighted_score
  ...
  def self.down
    ...
    remove_column :contents, :cached_votes_score
    remove_column :contents, :cached_votes_up
    remove_column :contents, :cached_votes_down
    remove_column :contents, :cached_weighted_score
  end
end